# Event.create(name: "Fyre", date: 10/27/2019, location: "Houston")
# Event.create(name: "Lolapalooza", date: 6/27/2019, location: "Dallas")
# Event.create(name: "Woodstock", date: 8/27/2019, location: "Austin")
# Event.create(name: "Buzz Fest", date: 10/15/2020, location: "Houston")
# Event.create(name: "Burning Man", date: 10/27/2019, location: "California")
